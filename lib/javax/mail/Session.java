...
public final class Session {
    ...
    private boolean debug = true;///////////<------ POR DEFECTO ES FALSE,
	...
	if (debug)
	    pr("DEBUG: JavaMail version " + "Version.version jejejejej");
	...
	this.debug = debug;
	if (debug)
	    pr("DEBUG: setDebug: JavaMail version " + "Version.version jejeje");
    }//Version
	...
	if (is != null) {
		...
		while (tuples.hasMoreTokens()) {
		    ...
		    //// hara algo esto??
		    // NO
		    System.out.println(lis.readLine());
		}
