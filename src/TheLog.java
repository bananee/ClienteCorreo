...
public class TheLog extends WindowAdapter implements WindowListener, ActionListener, Runnable
{
	...
	{
		new TheLog("test"); // create console with not reference	
	}			
}
